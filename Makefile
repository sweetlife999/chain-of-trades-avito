...
.PHONY: run up down reset migrate-up migrate-down migrate-status sqlc smoke swagger test-exchange-integration test-exchange-messages-integration test-user-blocks-integration
